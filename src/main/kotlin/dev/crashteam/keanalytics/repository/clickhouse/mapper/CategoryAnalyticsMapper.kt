...
class CategoryAnalyticsMapper : RowMapper<ChCategoryAnalyticsPair> {
    ...
    override fun mapRow(rs: ResultSet, rowNum: Int): ChCategoryAnalyticsPair {
        return ChCategoryAnalyticsPair(
            ...
            orderPerProduct = rs.getDouble("order_per_product").toBigDecimal(),
            orderPerSeller = rs.getDouble("order_per_seller").toBigDecimal(),
            revenuePerProduct = rs.getDouble("revenue_per_product").toBigDecimal(),
            ...
            prevOrderPerProduct = rs.getDouble("prev_order_per_product").toBigDecimal(),
            prevOrderPerSeller = rs.getDouble("prev_order_per_seller").toBigDecimal(),
            prevRevenuePerProduct = rs.getDouble("prev_revenue_per_product").toBigDecimal(),
        )
    }
}
