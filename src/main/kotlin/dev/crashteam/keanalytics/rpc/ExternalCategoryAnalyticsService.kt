...
class ExternalCategoryAnalyticsService(
        ...
        try {
            ...
            if (!checkRequestDaysPermission(request.userId, request.datePeriod)) {
                responseObserver.onNext(
                    GetCategoryAnalyticsResponse
                        .newBuilder()
                        .apply {
                            this.errorResponse =
                                GetCategoryAnalyticsResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
                    ...
                    try {
                        if (request.hasCategoryId()) {
                            categoryAnalyticsService.getCategoryAnalytics(
                                ...
                                sortBy =
                                    if (request.sortList.isNotEmpty()) {
                                        SortBy(
                                            sortFields =
                                                request.sortList.map {
                                                    SortField(
            ...
            if (categoriesAnalytics.isEmpty()) {
                    ...
                    GetCategoryAnalyticsResponse
                        ...
                        .apply {
                            this.successResponse =
                                GetCategoryAnalyticsResponse.SuccessResponse
                                    .newBuilder()
                                    .apply {
                                        this.addAllCategories(
                                            categoriesAnalytics.map { categoryAnalyticsInfo ->
    ...
    override fun getCategoryDailyAnalytics(
        ...
        try {
            ...
            if (!checkRequestDaysPermission(request.userId, fromDate, toDate)) {
                responseObserver.onNext(
                    GetCategoryDailyAnalyticsResponse
                        .newBuilder()
                        .apply {
                            this.errorResponse =
                                GetCategoryDailyAnalyticsResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
            ...
            val categoryDailyAnalytics =
                categoryAnalyticsService.getCategoryDailyAnalytics(
                    categoryId = request.categoryId,
                    fromTime = fromDate,
                    toTime = toDate,
                )
            ...
            responseObserver.onNext(
                GetCategoryDailyAnalyticsResponse
                    ...
                    .apply {
                        this.successResponse =
                            GetCategoryDailyAnalyticsResponse.SuccessResponse
                                .newBuilder()
                                .apply {
                                    this
                                        .addAllCategoryDailyAnalyticsInfo(
                                            categoryDailyAnalytics.map { categoryDailyAnalytics ->
    ...
    override fun getCategoryAnalyticsProducts(
        ...
        try {
            ...
            if (!checkRequestDaysPermission(request.userId, request.datePeriod)) {
                responseObserver.onNext(
                    GetCategoryAnalyticsProductResponse
                        .newBuilder()
                        .apply {
                            this.errorResponse =
                                GetCategoryAnalyticsProductResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
                                        this.errorCode =
            ...
            val productsAnalytics =
                categoryAnalyticsService.getCategoryProductsAnalytics(
                    categoryId = request.categoryId,
                    datePeriod = request.datePeriod,
            ...
            responseObserver.onNext(
                GetCategoryAnalyticsProductResponse
                    ...
                    .apply {
                        this.successResponse =
                            GetCategoryAnalyticsProductResponse.SuccessResponse
                                .newBuilder()
                                .apply {
                                    this.categoryProductAnalytics =
                                        CategoryProductAnalytics
                                            .newBuilder()
                                            .apply {
    ...
    override fun getProductDailyAnalytics(
        ...
        try {
            ...
            if (!checkRequestDaysPermission(request.userId, fromDate, toDate)) {
                responseObserver.onNext(
                    GetProductDailyAnalyticsResponse
                        .newBuilder()
                        .apply {
                            this.errorResponse =
                                GetProductDailyAnalyticsResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
            ...
            val productDailyAnalytics =
                productServiceAnalytics.getProductDailyAnalytics(
            ...
            if (productDailyAnalytics == null) {
                ...
                responseObserver.onNext(
                    GetProductDailyAnalyticsResponse
                        ...
                        .apply {
                            this.successResponse =
                                GetProductDailyAnalyticsResponse.SuccessResponse
                                    .newBuilder()
                                    .apply {
            ...
            if (categoryInfo == null) {
                responseObserver.onNext(
                    GetCategoryDataResponse
                        ...
                        .apply {
                            this.errorResponse =
                                GetCategoryDataResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
                ...
                responseObserver.onNext(
                    GetCategoryDataResponse
                        ...
                        .apply {
                            this.successResponse =
                                GetCategoryDataResponse.SuccessResponse
                                    .newBuilder()
                                    .apply {
                                        this.categoryInfo =
                                            CategoryInfo
    ...
    override fun getTrendingCategoryProducts(
        request: GetTrendingCategoryProductsRequest,
        responseObserver: StreamObserver<GetTrendingCategoryProductsResponse>,
    ) {
        try {
            log.debug { "Request getTrendingCategoryProducts: $request" }
            val fromDate = LocalDate.now().minusDays(14)
            val toDate = LocalDate.now()
            if (!checkRequestDaysPermission(request.userId, fromDate, toDate)) {
                responseObserver.onNext(
                    GetTrendingCategoryProductsResponse
                        .newBuilder()
                        .apply {
                            this.errorResponse =
                                GetTrendingCategoryProductsResponse.ErrorResponse
                                    .newBuilder()
                                    .apply {
                                        this.errorCode =
                                            GetTrendingCategoryProductsResponse.ErrorResponse.ErrorCode.ERROR_CODE_FORBIDDEN
                                    }.build()
                        }.build(),
                )
                return
            }
            val trendingCategoryProducts =
                runBlocking {
                    categoryAnalyticsService.getTrendingCategoryProducts(request.categoryId)
                }
            responseObserver.onNext(
                GetTrendingCategoryProductsResponse
                    .newBuilder()
                    .apply {
                        this.successResponse =
                            GetTrendingCategoryProductsResponse.SuccessResponse
                                .newBuilder()
                                .apply {
                                    this.addAllTrendingProducts(
                                        trendingCategoryProducts.map {
                                            TrendingProduct
                                                .newBuilder()
                                                .apply {
            ...
            log.error(e) { "Exception during get trending category products" }
            responseObserver.onNext(
                GetTrendingCategoryProductsResponse
                    .newBuilder()
                    .apply {
                        this.errorResponse =
                            GetTrendingCategoryProductsResponse.ErrorResponse
                                ...
                                .apply {
                                    this.errorCode =
                                        GetTrendingCategoryProductsResponse.ErrorResponse.ErrorCode.ERROR_CODE_UNEXPECTED
                                }.build()
                    }.build(),
            )
        } finally {
